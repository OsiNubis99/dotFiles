...
myPromptConfig = def { bgColor             = sumiInk0
                     , fgColor             = oldWhite
                     , bgHLight            = oldWhite
                     , fgHLight            = sumiInk0
                     , historySize         = 0
...
myShowWNameConfig = def { swn_font    = "xft:Vanilla Caramel:size=60"
                        , swn_color   = oldWhite
...
myTabConfig :: Theme
myTabConfig = def { activeColor         = oldWhite
